(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".seat-free img, .seat-free-two img").on("click", function () {
            let isBooked = $(this).attr("data-booked") === "true";

            
            let freeImg = $(this).attr("src").includes("seat01") ? "/images/movie/seat01-free.png" : "/images/movie/seat02-free.png";
            let bookedImg = $(this).attr("src").includes("seat01") ? "/images/movie/seat01-booked.png" : "/images/movie/seat02-booked.png";

            $(this).attr("src", isBooked ? freeImg : bookedImg);
            $(this).attr("data-booked", isBooked ? "false" : "true");
        });
        // Xử lý tăng/giảm số lượng vé
        // Thêm nút + và - vào input (nếu chưa có)
        //var CartPlusMinus = $('.cart-plus-minus');
        //if (CartPlusMinus.find(".qtybutton").length === 0) {
        ...
        //    $input.val(newVal); // Cập nhật số lượng vé
        //    console.log("🎟 Số lượng vé sau khi cập nhật:", newVal);
        //});

        //// Xử lý chọn ghế
        //$(".seat-free img, .seat-free-two img").on("click", function () {
        //    let quantity = parseInt($(".cart-plus-minus input").val()) || 0;

        //    if (quantity <= 0) {
        //        alert("⚠ Vui lòng chọn giá vé trước khi chọn ghế!");
        //        return;
        //    }
        ...
        //    console.log("✅ Ghế đã chọn, số lượng vé hiện tại:", quantity);
        //});
